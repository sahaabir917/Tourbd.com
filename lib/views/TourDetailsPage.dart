...
import 'package:shopx/views/bottomsheet/CommentBottomSheet.dart';
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text("${tourController.tourModel[index].difficulty}",
                              style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 14.0)),
                    ...
                    CarouselSlider(
                      options: CarouselOptions(
                          ...
                          enableInfiniteScroll: false,
                          initialPage: 1),
                      items: tourController.tourModel[index].locations.map((i) {
                        return Builder(
                          builder: (BuildContext context) {
                            return Container(
                                width: MediaQuery.of(context).size.width,
                    ...
                    Padding(
                      ...
                      child: LinearPercentIndicator(
                        ...
                        percent:
                            tourController.tourModel[index].ratingsAverage / 10,
                      ),
                    ),
                    SizedBox(
                      height: 8.0,
